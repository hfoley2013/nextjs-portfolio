      ...
      <div className="flex mx-auto">
        ...
        <div className="bg-black text-white font-mono p-4 mx-auto rounded-lg w-1/2">
          ...
          <div className="my-4">
            ...
            <span className="mx-2 text-md">{about}</span>
          </div>
        </div>
      </div>
    </>
