...
export default function About() {
  ...
  return (
    <>
      <h1 className="text-4xl text-gray-300 mb-4 text-center sm:text-3xl">{tagLine}</h1>
      <div className="flex flex-col md:flex-row mx-auto">
      <span className="order-1 md:order-1 bg-slate-200 inline-block mt-14 mx-auto mb-8 pt-3.5 px-3.5 pb-7 text-center relative">
        <Image
          className="block"
          src={profilePhoto}
          height={500}
        ...
        <div className="order-2 md:order-2 bg-black text-white font-mono p-4 mx-auto rounded-lg w-full md:w-1/2">
          <div className="flex">
