...
export default function Home() {
  return (
    <>
      <section className="bg-gray-900 h-full flex justify-center align-center max-w-screen mx-auto px-4 sm:px-6 lg:px-8 y-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 y-12">
